...
exports.getMedication = exports.createMedication = void 0;
...
const createMedication = (medication) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield MedicationDal.createMedication(medication);
});
exports.createMedication = createMedication;
const getMedication = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('Service...getMedication...');
    return yield MedicationDal.getMedication(filters);
});
